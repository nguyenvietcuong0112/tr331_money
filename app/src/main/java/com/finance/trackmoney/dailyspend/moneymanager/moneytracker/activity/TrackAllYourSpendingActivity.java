...
import com.finance.trackmoney.dailyspend.moneymanager.moneytracker.utils.AssistiveTouch;
...
public class TrackAllYourSpendingActivity extends BaseActivity implements TransactionAdapter.OnTransactionClickListener {
    ...
    ImageView ivIncome, ivExpend ,ivBack;
    String totalAmount;
    ...
    @Override
    public void bind() {
        setContentView(R.layout.track_all_your_spending_activity);
    ...
    private void initViews() {
        ...
        fabAdd.setOnTouchListener(new AssistiveTouch());
    ...
    private void startAddTransactionActivity() {
        Intent intent = new Intent(TrackAllYourSpendingActivity.this, AddTransactionActivity.class);
    ...
    private void updateTotalAmount() {
        ...
        switch (currentTransactionType) {
            case "Income":
                ...
                ivIncome.setImageResource(R.drawable.ic_income);
                ivExpend.setImageResource(R.drawable.ic_expense_false);
                break;
            case "Expense":
                ...
                ivIncome.setImageResource(R.drawable.ic_income_false);
                ivExpend.setImageResource(R.drawable.ic_expense);
                break;
            case "Loan":
    ...
    protected void onResume() {
        ...
        if (!SharePreferenceUtils.isOrganic(this)) {
            if (isFirstLoad) {
                ...
                loadNativeCollap(() -> {
                    delayedLoadExpandTask = this::loadNativeExpnad;
    ...
    private void loadNativeCollap(@Nullable final Runnable onLoaded) {
        ...
        Admob.getInstance().loadNativeAd(this, getString(R.string.native_collap_home), new NativeCallback() {
            ...
            public void onNativeAdLoaded(NativeAd nativeAd) {
                ...
                NativeAdView adView = (NativeAdView) LayoutInflater.from(TrackAllYourSpendingActivity.this).inflate(R.layout.layout_native_home_collap, null);
                if (frAdsCollap != null) {
                    frAdsCollap.removeAllViews();
    ...
    private void loadNativeExpnad() {
        ...
        Admob.getInstance().loadNativeAd(this, getString(R.string.native_expand_home), new NativeCallback() {
            ...
            public void onNativeAdLoaded(NativeAd nativeAd) {
                ...
                NativeAdView adView = (NativeAdView) LayoutInflater.from(TrackAllYourSpendingActivity.this).inflate(R.layout.layout_native_home_expnad, null);
                if (frAdsHomeTop != null) {
                    frAdsHomeTop.removeAllViews();
